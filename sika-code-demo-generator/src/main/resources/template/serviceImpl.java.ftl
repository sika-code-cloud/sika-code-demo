 ...
 */
@Service
public class ${entity} extends BaseDemoServiceImpl${r"<"}${sikaEntityBodyName}PO, ${sikaEntityBodyName}DTO, ${sikaEntityBodyName}Repository> implements ${sikaEntityBodyName}Service {
