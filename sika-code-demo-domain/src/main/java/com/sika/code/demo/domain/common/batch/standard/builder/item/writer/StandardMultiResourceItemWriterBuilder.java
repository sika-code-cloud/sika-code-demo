package com.sika.code.demo.domain.common.batch.standard.builder.item.writer;
...
import com.sika.code.demo.domain.common.batch.core.item.writer.MultiResourceItemWriterSupport;
...
import com.sika.code.demo.domain.common.batch.standard.bean.writer.FlatWriterBean;
import lombok.Data;
...
public class StandardMultiResourceItemWriterBuilder implements BaseItemWriterBuilder<Map<String, Object>> {
    ...
    private ResourceAwareItemWriterItemStream<Map<String, Object>> subWriterItem(FlatWriterBean writerBean, BatchBean batchBean) {
        return (ResourceAwareItemWriterItemStream<Map<String, Object>>) BatchFactory.getItemWriter(batchBean, writerBean.getSubBuilderType());
    }
}
